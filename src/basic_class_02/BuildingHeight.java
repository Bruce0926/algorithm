            ...
            for(int j=0;j<grid[i].length;j++){
                ...
                if(horizontalMax<0){
                    for(int m=0;m<grid[i].length;m++){
                        if(horizontalMax<grid[i][m]){
                            horizontalMax=grid[i][m];
                        }
                    }
                }
                //纵向比较获取最大值
                if(verticalMax[j]<=0){
                    for(int m=0;m<length;m++){
                        if(verticalMax[j]<grid[m][j]){
                            verticalMax[j]=grid[m][j];
                        }
                    }
                }
                int min = horizontalMax > verticalMax[j] ? verticalMax[j] : horizontalMax;
                result += (min-item);
            }
        }
        return result;
